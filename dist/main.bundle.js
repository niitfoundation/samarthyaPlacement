    ...
    AdminRegistrationComponent.prototype.save = function (userdata) {
        ...
        this.PlacementRegisterService.add(userData).subscribe(function (resJsonData) {
            if (resJsonData['success'] == true) {
                ...
                _this.router.navigate(['/login']);
                _this.data.openSnackBar(resJsonData['message'], "OK");
                return true;
            }
            else {
                _this.data.openSnackBar(resJsonData['message'], "OK");
...
var ForgotPasswordComponent = (function () {
    ...
    ForgotPasswordComponent.prototype.onResetLink = function () {
        ...
        this.emailService.sendEmail(this.infoobj).subscribe(function (resEmailData) {
            _this.openSnackBar('PASSWORD RESET LINK SENT', 'Please Check your mail'),
...
var LoginComponent = (function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        this.authenticationService.login(value["email"], value["password"])
            ...
            _this.data.openSnackBar("", 'Ok');
            _this.router.navigate(['/home']);
        }, function (error) {
            _this.data.openSnackBar(error.result, 'Try again');
            _this.router.navigate(['/home']);
        });
    };
...
var PasswordResetComponent = (function () {
    ...
    PasswordResetComponent.prototype.ngOnInit = function () {
        ...
        if (this.reset == 'reset') {
            ...
            this.route.params.subscribe(function (params) { return _this.token = params['reset']; });
            var encoded = this.token.split('.')[1];
...
//# sourceMappingURL=/home/gowtham/Desktop/Projectgit_final/samarthyaPlacement/webclient/profileCard.component.js.map
